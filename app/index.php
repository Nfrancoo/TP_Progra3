...
$app->group('/pedidos', function (RouteCollectorProxy $group) {
  ...
  $group->post('[/]', \PedidoController::class.':CargarUno')->add(new ConfirmarRol('socio'));
  $group->put('[/]', \PedidoController::class.':ModificarUno')->add(\ValidarPedidos::class.':ValidarEstado')->add(\ValidarPedidos::class.':ValidarMesaExistente')->add(new ConfirmarRol('socio', 'mozo'));
...
$app->get('/mejores-comentarios', \ComentarioController::class.':TraerMejores')->add(new ConfirmarRol('socio'));
...
})->add(new ConfirmarRol('socio'))->add(\Logger::class.':ValidarSesion');
